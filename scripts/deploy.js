...
async function main(){
  ...
  const RealEstate = await ethers.getContractFactory('RealEstate');
      ...
      const Escrow = await ethers.getContractFactory("Escrow");
       ...
       console.log(`Deploying Escrow contract at: ${escrow.address} \n`);
